...
Write a function named replaceZeros that, given a string, uses Regex 
to replace all '0' with the word 'zero'. 
------------------------------------------------------------------------------------------------ */

const replaceZeros = (string) => {
  // Solution code here...
let m= /0/g
 return string.replace(m, 'zero');
...
const addOne = (arr) => {
  // Solution code here...
  let array=arr.map(itam=>{return itam+1})
  return array;
}
...
const addQuestion = (arr) => {
  // Solution code here...
  let array=arr.map(itam=>{return itam+'?';})
  return array;
}
...
Write a function named forLoopTwoToThe that, given an array 
of integers as input, iterates over the array and returns a new array.
 The returned array should contain the result of raising 2 to the power of
...
const forLoopTwoToThe = (arr) => {
  ...
  for (const property in arr) {
    array.push(Math.pow(2,arr[property]));
  }return array;
};
...
Write a function named forEachTwoToThe that produces the same
 output as your forLoopTwoToThe function from challenge 1, but
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let array=[];
  arr.forEach(itam=> {array.push(Math.pow(2,itam));})
  return array;
...
Write a function named mapTwoToThe that produces the same output as
 your forLoopTwoToThe function from challenge 1 and your forEachTwoToThe 
 function from challenge 2, but uses map instead of a for loop or forEach.
------------------------------------------------------------------------------------------------ */

const mapTwoToThe = (arr) => {
  // Solution code here...
  let array=[];
  arr.map(itam=> {array.push(Math.pow(2,itam));})
  return array;
