...
Write a function named longestString that takes in an array of strings and returns the index
...
strings and returns an array containing only the first letter 
of each string.
...
const firstLetters = (arr) => {
  // Solution code here...
  return arr.map(itam=> itam[0]);
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 3

Write a function named findHappiness that takes in an array 
of strings and returns an array containing only the strings 
...
const findHappiness = (arr) => {
  // Solution code here...
  return arr.filter(itam=>itam.includes(':)'))
...
Write a function named standardizePhoneNumbers that takes in an 
array of phone number strings in (XXX) XXX-XXXX format
 and returns an array with the phone number strings
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(itam=>itam.split(/\D/).join(''));
...
Write a function named onlyOddChars that takes in a string and 
returns only the odd-index characters from that string.
...
const onlyOddChars = (str) => {
  // Solution code here...
  return str.split('').filter((itam,index)=> index %2).join('');
};
...
strings and returns a Boolean indicating whether all those
 strings contain ":)".
------------------------------------------------------------------------------------------------ */

const allHappy = (arr) => {
  // Solution code here...
  return arr.every(itam=>itam.includes(':)'));
};
